 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.cNL.impl.EquExpressionImpl#getEquOp <em>Equ Op</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EquExpressionImpl extends CompExpressionImpl implements EquExpression
{
  ...
  {
    return CNLPackage.Literals.EQU_EXPRESSION;
  }
  ...
  public void setEquOp(EquOperator newEquOp)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CNLPackage.EQU_EXPRESSION__EQU_OP, oldEquOp, equOp));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case CNLPackage.EQU_EXPRESSION__EQU_OP:
        return getEquOp();
    }
