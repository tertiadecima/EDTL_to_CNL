 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.cNL.impl.DeclVarOutputImpl#getVarDecls <em>Var Decls</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DeclVarOutputImpl extends MinimalEObjectImpl.Container implements DeclVarOutput
{
  ...
  {
    return CNLPackage.Literals.DECL_VAR_OUTPUT;
  }
  ...
  public EList<VarDeclaration> getVarDecls()
  {
    if (varDecls == null)
    {
      varDecls = new EObjectContainmentEList<VarDeclaration>(VarDeclaration.class, this, CNLPackage.DECL_VAR_OUTPUT__VAR_DECLS);
    }
    return varDecls;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case CNLPackage.DECL_VAR_OUTPUT__VAR_DECLS:
