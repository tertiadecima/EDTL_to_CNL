...
public class CNLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, CNLGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getID_or_INTEGERAccess().getAlternatives_1(), "rule__ID_or_INTEGER__Alternatives_1");
			...
			builder.put(grammarAccess.getID_or_INTEGERAccess().getGroup(), "rule__ID_or_INTEGER__Group__0");
			...
			builder.put(grammarAccess.getSentenceAccess().getNameAssignment_1(), "rule__Sentence__NameAssignment_1");
